  ...
  return (
    <>
      <header className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-5 py-12 md:px-8 md:py-16">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-relaxed text-muted-foreground md:text-base">
            Nothing in a legitimate assessment starts before this document is agreed and signed. The
            rules of engagement below are synthetic and illustrative, but they follow the structure
            a real engagement requires: what may be touched, what may never be touched, how evidence
            is handled, and when testing stops.
          </p>
        </div>
      </header>
      ...
      <Section
        ...
        description="Synthetic engagement record for the portfolio lab."
      >
        <Panel>
          <DataList
            items={[
      ...
      <Section title="Authorization statement">
        <Panel className="border-primary/35 bg-primary/5">
          <p className="text-sm leading-relaxed text-foreground/90">
            Written authorization from the asset owner is required before any real testing activity
            begins. That authorization must name the in-scope assets, the testing window, the
            approved techniques, the emergency contacts, and the stop conditions. No assessment
            activity in this lab was performed against any real system: the engagement described
            here does not exist, and the authorization statement is presented to demonstrate the
            control, not to imply one was granted.
          </p>
        </Panel>
      </Section>
      ...
      <Section
        ...
        description="Authorized assets are explicit; anything not listed is out of scope by default."
      >
      ...
      <Section
        title="Techniques and prohibitions"
        description="Stated at a high level. Techniques are described, never operationalized."
      >
        <div className="grid gap-4 lg:grid-cols-2">
          <Panel>
